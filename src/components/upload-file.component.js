...
// Import assets
//import { ReactComponent  } from 'assets/icon/upload.svg'

import { MdAddAPhoto as UploadIcon } from 'react-icons/md'
...
export default function UploadFile({
    ...
    return (
        <label
            ref={uploadFileRef}
            className={`UploadFile ${dragging ? 'active' : ''}`}>
            <UploadIcon size={80} />
            ...
            {currentFile !== null && (
                <p className='UploadFile-legend'>{currentFile.name}</p>
            )}
