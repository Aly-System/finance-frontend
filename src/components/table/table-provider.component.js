...
import ModalEditProvider from 'components/modal/modal-edit-provider.component'
    ...
    return (
        <main className='container__table'>
            ...
            <section
                ...
                <TableCell label={'Cedula-Ruc'}></TableCell>
                <TableCell label={''}></TableCell>
                <TableCell label={'Nombre del proveedor'}></TableCell>
                <TableCell label={''}></TableCell>
                <TableCell label={'cuenta contable'}></TableCell>
