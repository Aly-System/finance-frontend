...
function setAuth(token) {
    ...
    localStorage.setItem('_tkn_aly_finances', secureToken)
}
...
function getAuth() {
    ...
    let secureToken = localStorage.getItem('_tkn_aly_finances')
 ...
 */
function isAuth() {
    return localStorage.getItem('_tkn_aly_finances') !== null
}
